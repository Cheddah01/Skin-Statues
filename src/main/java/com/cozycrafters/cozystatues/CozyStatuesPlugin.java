...
import com.cozycrafters.cozystatues.skin.HttpTextureDownloader;
import com.cozycrafters.cozystatues.skin.PaperProfileSource;
import com.cozycrafters.cozystatues.skin.SkinService;
import com.cozycrafters.cozystatues.statue.StatuePlacer;
 ...
 * disable so a PlugManX-style reload leaves no task behind.
 */
public final class CozyStatuesPlugin extends JavaPlugin {
    ...
    public void onEnable() {
        ...
        getLogger().info("CozyStatues ready: max scale " + config.maxScale()
    ...
    public void onDisable() {
        ...
        try {
            ...
            getLogger().log(Level.SEVERE, "CozyStatues shutdown cleanup failed.", ex);
        }
        statues = null;
        placer = null;
        skins = null;
