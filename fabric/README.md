...
3. Add `SkinStatues-Fabric-1.0.0.jar` to the same directory.
4. Start the server.
...
Java 25 is required. From this `fabric` directory:
...
The production mod is written to `build/libs/SkinStatues-Fabric-1.0.0.jar`.
