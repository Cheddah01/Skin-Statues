...
import com.cozycrafters.skinstatues.fabric.model.BoxFace;
...
import com.cozycrafters.skinstatues.fabric.model.TextureMapper;
...
public final class StatuePlanner {
    ...
    public record PlannedPixel(int x, int y, int z, Block material) {
    }
    ...
    public List<PlannedPixel> planPixels(SkinTexture skin, PlayerModel model, ModelBounds bounds) {
        Map<Integer, Block> voxels = new LinkedHashMap<>();
    ...
    private void addBox(SkinTexture skin, ModelBox box, TextureRegion region,
                        ModelBounds bounds, Map<Integer, Block> voxels) {
